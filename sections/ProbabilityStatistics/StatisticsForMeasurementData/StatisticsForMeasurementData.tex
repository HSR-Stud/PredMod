...
corresponding statistical test does not reject the null hypothesis. 
				...
				&{\lstinputlisting[style=R]{sections/ProbabilityStatistics/StatisticsForMeasurementData/RCode/tTest2.R}}\vspace*{0.1cm}{\lstinputlisting[style=R]{sections/ProbabilityStatistics/StatisticsForMeasurementData/RCode/tTest3.R}}\\ 
				\hline
\twoColHdrRow{$P$-Value}\\
\hline
